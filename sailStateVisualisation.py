...
if (not VANES_BOOL): acs_object.set_shifted_panel_characteristics(panel_coordinates_list, wing_area_list, wings_rotation_matrices_list, boom_list, keep_constant_area=keep_area)
