...
# Change panel coordinates to test shifted panels implementation
...
sail = sail_craft(4, 0, panel_coordinates_list, [], panels_optical_properties, vanes_optical_properties,
                  sail_I, 16, 15.66, np.array([0, 0, 0.05]), 0.00425, acs_object)
wing_area_list = [sail.get_ith_panel_area(-1, i, "Sail") for i in range(4)]
acs_object.set_shifted_panel_characteristics(panel_coordinates_list, wing_area_list, wings_rotation_matrices_list, boom_list, keep_constant_area=True)
