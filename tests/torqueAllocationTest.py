...
# tolerances
tol_vane_angle_determination_start_golden_section = algorithm_constants["tol_vane_angle_determination_start_golden_section"]
tol_vane_angle_determination_golden_section = algorithm_constants["tol_vane_angle_determination_golden_section"]
tol_vane_angle_determination_global_search = algorithm_constants["tol_vane_angle_determination"]

tol_torque_allocation_problem_constraint = algorithm_constants["tol_torque_allocation_problem_constraint"]
tol_torque_allocation_problem_objective = algorithm_constants["tol_torque_allocation_problem_objective"]
tol_torque_allocation_problem_x = algorithm_constants["tol_torque_allocation_problem_x"]
