...
from LongTermTumblingAnalysis.longTermTumbling_ACS3Model import analysis_save_data_dir
import os
...
if (not overwrite_previous_bool):
    ...
    for comb in all_combinations:
        ...
        tentative_file = analysis_save_data_dir + f'/LTT_NoAsymetry_data_ACS3/states_history/state_history_omega_x_{rotations_per_hour[0]}_omega_y_{rotations_per_hour[1]}_omega_z_{rotations_per_hour[2]}.dat'
